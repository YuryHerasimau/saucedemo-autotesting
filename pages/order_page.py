...
class OrderPage(BasePage):
    ...
    @allure.step("Place an order with correct data")
    ...
    @allure.step("Place an order with incorrect data")
    ...
    @allure.step("Add item to cart and go to checkout")
    ...
    @allure.step("Fill in all the fields and click CONTINUE")
